...
// interface AssignmentImportWizardProps {
//   isOpen: boolean;
//   onClose: () => void;
// }

// export const AssignmentImportWizard: React.FC<AssignmentImportWizardProps> = ({
//   isOpen,
//   onClose,
// }) => {
//   const { importFromExcel, downloadTemplate, loading } =
...
//           </DialogTitle>
//           <DialogDescription>
//             Importez les affectations de cours depuis un fichier Excel
//           </DialogDescription>
//         </DialogHeader>
...
//                   </p>
//                   <p>
//                     • <strong>nomProfesseur</strong>: Nom complet du professeur
//                     (obligatoire)
//                   </p>
//                   <p>
//                     • <strong>nomFaculte</strong>: Nom de la faculté
//                     (obligatoire)
//                   </p>
//                   <p>
...
//                         Affectations créées (
//                         {importResult.details.reussites.length})
//                       </h4>
//                       <div className="space-y-2 max-h-60 overflow-y-auto">
