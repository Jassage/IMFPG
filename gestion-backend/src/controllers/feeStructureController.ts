...
export const getAllFeeStructures = async (req: Request, res: Response) => {
  ...
  try {
    const filters: FeeStructureFilters = {
    ...
    await createAuditLog({
      ...
      metadata: {
        updatedFields: Object.keys(data).filter(
          (key) => data[key as keyof UpdateFeeStructureData] !== undefined
        ),
      },
    });
...
export const getFeeStructureByAcademicYear = async (
  ...
  try {
    ...
    const result =
      await feeStructureService.getFeeStructureByAcademicYear(academicYear);
...
export const getFeeStructuresByAcademicYearId = async (
  ...
  try {
    ...
    const result =
      await feeStructureService.getFeeStructuresByAcademicYearId(
        academicYearId
      );
 ...
 */
export const getFeeStructureStats = async (req: Request, res: Response) => {
  const auditData = extractAuditData(req);
