...
const login = async (req, res) => {
    ...
    try {
        ...
        const userProfile = await userService_1.UserService.getUserProfileWithRoleData(user.id);
...
const getMe = async (req, res) => {
    ...
    try {
        ...
        const userProfile = await userService_1.UserService.getUserProfileWithRoleData(userId);
        await (0, auditController_1.createAuditLog)({
            ...auditData,
