...
exports.getGradeStatistics = exports.bulkImportGrades = exports.getStudentGrades = exports.deleteGrade = exports.updateGrade = exports.createGrade = exports.getGradeById = exports.getGrades = void 0;
...
const getGrades = async (req, res) => {
    ...
    try {
        const { page = 1, limit = 20, search, studentId, subjectId, assignmentId, academicYearId, classLevel, controlType, session, status, minGrade, maxGrade, startDate, endDate, sortBy = "createdAt", sortOrder = "desc", } = req.query;
        ...
        if (minGrade || maxGrade) {
            where.grade = {};
            if (minGrade)
                where.grade.gte = parseFloat(minGrade);
            if (maxGrade)
                where.grade.lte = parseFloat(maxGrade);
        }
        // Filtre par date
...
const createGrade = async (req, res) => {
    const auditData = (0, authUtils_1.extractAuditData)(req);
    try {
        const { studentId, subjectId, assignmentId, grade: gradeValue, status, session, controlType, academicYearId, classLevel, notes, } = req.body;
...
const updateGrade = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const { grade: gradeValue, status, session, controlType, notes, isActive, } = req.body;
...
const getStudentGrades = async (req, res) => {
    ...
    try {
        ...
        const { academicYearId, classLevel, controlType, session, subjectId } = req.query;
...
exports.bulkImportGrades = bulkImportGrades;
/**
...
const getGradeStatistics = async (req, res) => {
    const auditData = (0, authUtils_1.extractAuditData)(req);
    try {
        const { academicYearId, classLevel, controlType, subjectId, startDate, endDate, } = req.query;
        // Construction des filtres
