...
exports.getPotentialDeans = exports.getCurrentUser = exports.changePassword = exports.deleteUser = exports.updateUser = exports.getUserById = exports.getUsers = exports.loginUser = exports.registerUser = void 0;
...
const getPotentialDeans = async (req, res) => {
    const auditData = {
    ...
    try {
        ...
        const deans = await prisma_1.default.user.findMany({
            where: {
                role: "Doyen",
            },
            select: {
...
exports.getPotentialDeans = getPotentialDeans;
