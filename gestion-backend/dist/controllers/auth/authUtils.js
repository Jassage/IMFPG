...
exports.calculateRemainingLockTime = exports.isAccountLocked = exports.sanitizeUserForResponse = exports.generateEmailTemplate = exports.generateResetLink = exports.getClientIp = exports.createSafeAuditData = exports.extractAuditData = void 0;
/**
...
exports.extractAuditData = extractAuditData;
/**
 ...
 */
const createSafeAuditData = (data = {}) => {
    return {
...
exports.createSafeAuditData = createSafeAuditData;
/**
 ...
 */
const generateEmailTemplate = (firstName, resetLink) => {
    return `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
...
exports.sanitizeUserForResponse = sanitizeUserForResponse;
/**
 ...
 */
const calculateRemainingLockTime = (lockUntil) => {
    const now = new Date();
...
exports.calculateRemainingLockTime = calculateRemainingLockTime;
