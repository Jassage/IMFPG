...
class AuditService {
    static logCreate(entity, entityId, id, newData, arg4, ip) {
        throw new Error("Method not implemented.");
    }
    static logUpdate(entity, entityId, id, oldData, newData, arg5, ip) {
        throw new Error("Method not implemented.");
    }
    static logDelete(entity, entityId, id, oldData, arg4, ip) {
        throw new Error("Method not implemented.");
    }
