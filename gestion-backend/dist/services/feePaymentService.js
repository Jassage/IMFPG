...
exports.FeePaymentService = void 0;
...
class FeePaymentService {
     ...
     */
    static async getAllFeePayments(filters) {
    ...
    static async createFeePayment(data) {
        const { studentFeeId, amount, paymentMethod, reference, paymentDate, userId, } = data;
     ...
     */
    static async updateFeePayment(id, data) {
     ...
     */
    static async deleteFeePayment(id) {
...
exports.FeePaymentService = FeePaymentService;
//# sourceMappingURL=feePaymentService.js.map