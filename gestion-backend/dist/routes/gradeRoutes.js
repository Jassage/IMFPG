...
const gradeValidators_1 = require("../utils/gradeValidators");
 ...
 */
router.get("/", middleware_1.requireAuth, middleware_1.requireTeacherOrStaff, middleware_1.sanitizeInput, gradeValidators_1.validateGradeFilters, middleware_1.handleValidationErrors, gradeController_1.getGrades);
/**
 ...
 * @query {string} [endDate] - Date de fin (format ISO)
 */
router.get("/statistics", middleware_1.requireAuth, middleware_1.requireTeacher, middleware_1.sanitizeInput, gradeController_1.getGradeStatistics);
/**
 ...
 * @query {string} [subjectId] - ID de la matière
 */
router.get("/student/:studentId", middleware_1.requireAuth, middleware_1.sanitizeInput, gradeController_1.getStudentGrades);
/**
 ...
 */
router.get("/:id", middleware_1.requireAuth, middleware_1.requireStaff, middleware_1.sanitizeInput, gradeController_1.getGradeById);
/**
 ...
 */
router.post("/", middleware_1.requireAuth, middleware_1.requireTeacherOrStaff, (0, middleware_1.validateContentType)(), middleware_1.validateRequestBody, middleware_1.sanitizeInput, gradeValidators_1.validateCreateGrade, middleware_1.handleValidationErrors, gradeController_1.createGrade);
/**
 ...
 */
router.post("/bulk-import", middleware_1.requireAuth, middleware_1.requireTeacher, (0, middleware_1.validateContentType)(), middleware_1.validateRequestBody, middleware_1.sanitizeInput, gradeValidators_1.validateBulkImportGrades, middleware_1.handleValidationErrors, gradeController_1.bulkImportGrades);
/**
 ...
 */
router.put("/:id", middleware_1.requireAuth, middleware_1.requireTeacher, (0, middleware_1.validateContentType)(), middleware_1.validateRequestBody, middleware_1.sanitizeInput, gradeValidators_1.validateUpdateGrade, middleware_1.handleValidationErrors, gradeController_1.updateGrade);
/**
 ...
 * @param {string} id - ID de la note
 */
router.delete("/:id", middleware_1.requireAuth, middleware_1.requireAdmin, middleware_1.sanitizeInput, gradeController_1.deleteGrade);
