...
exports.validateAssignClass = exports.validateStudentStatusUpdate = exports.validateStudentSearch = exports.validateUpdateStudent = exports.validateCreateStudent = void 0;
...
exports.validateCreateStudent = [
    ...
    (0, express_validator_1.body)("sexe")
        .optional()
        .isIn(["M", "F", "Autre"])
        .withMessage("Le sexe doit être M, F ou Autre"),
    (0, express_validator_1.body)("cin")
        .optional()
        .trim()
    ...
    (0, express_validator_1.body)("status")
        ...
        .withMessage("Le statut doit être Active, Inactive, Graduated, Transferred ou Suspended"),
    (0, express_validator_1.body)("bloodGroup")
        ...
        .withMessage("Le groupe sanguin doit être A_POSITIVE, A_NEGATIVE, B_POSITIVE, B_NEGATIVE, AB_POSITIVE, AB_NEGATIVE, O_POSITIVE ou O_NEGATIVE"),
    (0, express_validator_1.body)("allergies")
        .optional()
        .trim()
        .isLength({ max: 500 })
        .withMessage("Les allergies ne doivent pas dépasser 500 caractères"),
    (0, express_validator_1.body)("disabilities")
        .optional()
        .trim()
        .isLength({ max: 500 })
 ...
 */
exports.validateStudentStatusUpdate = [
    (0, express_validator_1.param)("id")
        .exists()
        .withMessage("L'ID de l'étudiant est requis")
        .isString()
...
//# sourceMappingURL=studentValidators.js.map