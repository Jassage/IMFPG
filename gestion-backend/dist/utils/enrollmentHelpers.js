...
exports.canStudentBePromoted = canStudentBePromoted;
exports.determineNextClass = determineNextClass;
exports.validateStudentForReenrollment = validateStudentForReenrollment;
...
function getNextLevel(currentLevel) {
    const levelHierarchy = {
        [prisma_1.ClassLevel.Sixieme]: prisma_1.ClassLevel.Cinquieme,
        [prisma_1.ClassLevel.Cinquieme]: prisma_1.ClassLevel.Quatrieme,
        [prisma_1.ClassLevel.Quatrieme]: prisma_1.ClassLevel.Troisieme,
        [prisma_1.ClassLevel.Troisieme]: prisma_1.ClassLevel.Seconde,
        [prisma_1.ClassLevel.Seconde]: prisma_1.ClassLevel.Premiere,
        [prisma_1.ClassLevel.Premiere]: prisma_1.ClassLevel.Terminale,
        [prisma_1.ClassLevel.Terminale]: prisma_1.ClassLevel.NSI,
        [prisma_1.ClassLevel.NSI]: prisma_1.ClassLevel.NSII,
        [prisma_1.ClassLevel.NSII]: prisma_1.ClassLevel.NSIII,
        [prisma_1.ClassLevel.NSIII]: prisma_1.ClassLevel.NSIV,
        [prisma_1.ClassLevel.NSIV]: prisma_1.ClassLevel.NSIV, // Dernier niveau, reste le même
    };
 ...
 */
async function canStudentBePromoted(studentId, academicYearId) {
    try {
 ...
 */
async function determineNextClass(studentId, previousClassId, academicYearId) {
    try {
        ...
        const promotionResult = await canStudentBePromoted(studentId, academicYearId);
        let nextClassId = previousClassId;
        let promotionStatus = "Rétention";
        ...
        return {
            ...
            level: prisma_1.ClassLevel.Sixieme,
            promotionStatus: "Rétention",
 ...
 */
async function validateStudentForReenrollment(studentId) {
    try {
        ...
        const promotionResult = await canStudentBePromoted(studentId, lastEnrollment.academicYearId);
        ...
        const overdueFees = studentFees.filter((fee) => fee.dueDate < today && fee.totalAmount > fee.paidAmount);
        ...
        const nextClass = await determineNextClass(studentId, lastEnrollment.classId, lastEnrollment.academicYearId);
        const validation = {
            eligible,
            details: {
                student: {
...
//# sourceMappingURL=enrollmentHelpers.js.map