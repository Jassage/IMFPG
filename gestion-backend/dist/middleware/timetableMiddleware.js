...
exports.checkScheduleConflictsMiddleware = exports.canAccessClassTimetable = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
/**
 * Vérifie si l'utilisateur peut accéder à l'emploi du temps d'une classe
 */
const canAccessClassTimetable = async (req, res, next) => {
    try {
...
exports.canAccessClassTimetable = canAccessClassTimetable;
/**
 * Vérifie les conflits avant de créer/mettre à jour un horaire
 */
const checkScheduleConflictsMiddleware = async (req, res, next) => {
    try {
        ...
        if (professorConflicts.length > 0) {
            const response = {
                ...
                data: {
                    conflicts: professorConflicts.map((conflict) => ({
                        id: conflict.id,
        ...
        if (classConflicts.length > 0) {
            const response = {
                ...
                code: "CLASS_CONFLICT",
                data: {
                    conflicts: classConflicts.map((conflict) => ({
                        id: conflict.id,
                        subject: conflict.classAssignment?.subject?.name,
...
exports.checkScheduleConflictsMiddleware = checkScheduleConflictsMiddleware;
//# sourceMappingURL=timetableMiddleware.js.map