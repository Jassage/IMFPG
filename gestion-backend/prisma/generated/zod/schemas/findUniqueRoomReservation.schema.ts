...
export const RoomReservationFindUniqueSchema = z.object({ select: RoomReservationSelectObjectSchema.optional(), include: RoomReservationIncludeObjectSchema.optional(), where: RoomReservationWhereUniqueInputObjectSchema })