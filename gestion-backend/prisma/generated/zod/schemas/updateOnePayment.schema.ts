...
export const PaymentUpdateOneSchema = z.object({ select: PaymentSelectObjectSchema.optional(), include: PaymentIncludeObjectSchema.optional(), data: z.union([PaymentUpdateInputObjectSchema, PaymentUncheckedUpdateInputObjectSchema]), where: PaymentWhereUniqueInputObjectSchema  })