...
export const AcademicYearFindManySelectSchema: z.ZodType<Prisma.AcademicYearSelect, z.ZodTypeDef, Prisma.AcademicYearSelect> = z.object({
...
export const AcademicYearFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    year: z.boolean().optional(),
    startDate: z.boolean().optional(),
    endDate: z.boolean().optional(),
...
export const AcademicYearFindManySchema: z.ZodType<Prisma.AcademicYearFindManyArgs, z.ZodTypeDef, Prisma.AcademicYearFindManyArgs> = z.object({ select: AcademicYearFindManySelectSchema.optional(), include: z.lazy(() => AcademicYearIncludeObjectSchema.optional()), orderBy: z.union([AcademicYearOrderByWithRelationInputObjectSchema, AcademicYearOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcademicYearWhereInputObjectSchema.optional(), cursor: AcademicYearWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcademicYearScalarFieldEnumSchema, AcademicYearScalarFieldEnumSchema.array()]).optional() }).strict();

export const AcademicYearFindManyZodSchema = z.object({ select: AcademicYearFindManySelectSchema.optional(), include: z.lazy(() => AcademicYearIncludeObjectSchema.optional()), orderBy: z.union([AcademicYearOrderByWithRelationInputObjectSchema, AcademicYearOrderByWithRelationInputObjectSchema.array()]).optional(), where: AcademicYearWhereInputObjectSchema.optional(), cursor: AcademicYearWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AcademicYearScalarFieldEnumSchema, AcademicYearScalarFieldEnumSchema.array()]).optional() }).strict();