...
export const ScholarshipDocumentFindUniqueOrThrowSchema = z.object({ select: ScholarshipDocumentSelectObjectSchema.optional(), include: ScholarshipDocumentIncludeObjectSchema.optional(), where: ScholarshipDocumentWhereUniqueInputObjectSchema })