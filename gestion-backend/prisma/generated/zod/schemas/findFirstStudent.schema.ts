...
export const StudentFindFirstSelectSchema: z.ZodType<Prisma.StudentSelect, z.ZodTypeDef, Prisma.StudentSelect> = z.object({
...
export const StudentFindFirstSchema: z.ZodType<Prisma.StudentFindFirstArgs, z.ZodTypeDef, Prisma.StudentFindFirstArgs> = z.object({ select: StudentFindFirstSelectSchema.optional(), include: z.lazy(() => StudentIncludeObjectSchema.optional()), orderBy: z.union([StudentOrderByWithRelationInputObjectSchema, StudentOrderByWithRelationInputObjectSchema.array()]).optional(), where: StudentWhereInputObjectSchema.optional(), cursor: StudentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StudentScalarFieldEnumSchema, StudentScalarFieldEnumSchema.array()]).optional() }).strict();
