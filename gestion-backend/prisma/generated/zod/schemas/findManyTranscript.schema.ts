...
export const TranscriptFindManySelectSchema: z.ZodType<Prisma.TranscriptSelect, z.ZodTypeDef, Prisma.TranscriptSelect> = z.object({
...
export const TranscriptFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    student: z.boolean().optional(),
    studentId: z.boolean().optional(),
    semester: z.boolean().optional(),
...
export const TranscriptFindManySchema: z.ZodType<Prisma.TranscriptFindManyArgs, z.ZodTypeDef, Prisma.TranscriptFindManyArgs> = z.object({ select: TranscriptFindManySelectSchema.optional(), include: z.lazy(() => TranscriptIncludeObjectSchema.optional()), orderBy: z.union([TranscriptOrderByWithRelationInputObjectSchema, TranscriptOrderByWithRelationInputObjectSchema.array()]).optional(), where: TranscriptWhereInputObjectSchema.optional(), cursor: TranscriptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TranscriptScalarFieldEnumSchema, TranscriptScalarFieldEnumSchema.array()]).optional() }).strict();

export const TranscriptFindManyZodSchema = z.object({ select: TranscriptFindManySelectSchema.optional(), include: z.lazy(() => TranscriptIncludeObjectSchema.optional()), orderBy: z.union([TranscriptOrderByWithRelationInputObjectSchema, TranscriptOrderByWithRelationInputObjectSchema.array()]).optional(), where: TranscriptWhereInputObjectSchema.optional(), cursor: TranscriptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TranscriptScalarFieldEnumSchema, TranscriptScalarFieldEnumSchema.array()]).optional() }).strict();