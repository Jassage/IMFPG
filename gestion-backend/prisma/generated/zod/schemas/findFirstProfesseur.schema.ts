...
export const ProfesseurFindFirstSelectSchema: z.ZodType<Prisma.ProfesseurSelect, z.ZodTypeDef, Prisma.ProfesseurSelect> = z.object({
...
export const ProfesseurFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    firstName: z.boolean().optional(),
    lastName: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const ProfesseurFindFirstSchema: z.ZodType<Prisma.ProfesseurFindFirstArgs, z.ZodTypeDef, Prisma.ProfesseurFindFirstArgs> = z.object({ select: ProfesseurFindFirstSelectSchema.optional(), include: z.lazy(() => ProfesseurIncludeObjectSchema.optional()), orderBy: z.union([ProfesseurOrderByWithRelationInputObjectSchema, ProfesseurOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProfesseurWhereInputObjectSchema.optional(), cursor: ProfesseurWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProfesseurScalarFieldEnumSchema, ProfesseurScalarFieldEnumSchema.array()]).optional() }).strict();

export const ProfesseurFindFirstZodSchema = z.object({ select: ProfesseurFindFirstSelectSchema.optional(), include: z.lazy(() => ProfesseurIncludeObjectSchema.optional()), orderBy: z.union([ProfesseurOrderByWithRelationInputObjectSchema, ProfesseurOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProfesseurWhereInputObjectSchema.optional(), cursor: ProfesseurWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProfesseurScalarFieldEnumSchema, ProfesseurScalarFieldEnumSchema.array()]).optional() }).strict();