...
export const CourseAssignmentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CourseAssignmentSelect, z.ZodTypeDef, Prisma.CourseAssignmentSelect> = z.object({
...
export const CourseAssignmentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    ue: z.boolean().optional(),
    ueId: z.boolean().optional(),
    faculty: z.boolean().optional(),
...
export const CourseAssignmentFindFirstOrThrowSchema: z.ZodType<Prisma.CourseAssignmentFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.CourseAssignmentFindFirstOrThrowArgs> = z.object({ select: CourseAssignmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CourseAssignmentIncludeObjectSchema.optional()), orderBy: z.union([CourseAssignmentOrderByWithRelationInputObjectSchema, CourseAssignmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: CourseAssignmentWhereInputObjectSchema.optional(), cursor: CourseAssignmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CourseAssignmentScalarFieldEnumSchema, CourseAssignmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const CourseAssignmentFindFirstOrThrowZodSchema = z.object({ select: CourseAssignmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CourseAssignmentIncludeObjectSchema.optional()), orderBy: z.union([CourseAssignmentOrderByWithRelationInputObjectSchema, CourseAssignmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: CourseAssignmentWhereInputObjectSchema.optional(), cursor: CourseAssignmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CourseAssignmentScalarFieldEnumSchema, CourseAssignmentScalarFieldEnumSchema.array()]).optional() }).strict();