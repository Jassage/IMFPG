...
export const PaymentCreateOneSchema = z.object({ select: PaymentSelectObjectSchema.optional(), include: PaymentIncludeObjectSchema.optional(), data: z.union([PaymentCreateInputObjectSchema, PaymentUncheckedCreateInputObjectSchema])  })