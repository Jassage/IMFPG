...
export const PaymentFindFirstSelectSchema: z.ZodType<Prisma.PaymentSelect, z.ZodTypeDef, Prisma.PaymentSelect> = z.object({
...
export const PaymentFindFirstSchema: z.ZodType<Prisma.PaymentFindFirstArgs, z.ZodTypeDef, Prisma.PaymentFindFirstArgs> = z.object({ select: PaymentFindFirstSelectSchema.optional(), include: z.lazy(() => PaymentIncludeObjectSchema.optional()), orderBy: z.union([PaymentOrderByWithRelationInputObjectSchema, PaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: PaymentWhereInputObjectSchema.optional(), cursor: PaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PaymentScalarFieldEnumSchema, PaymentScalarFieldEnumSchema.array()]).optional() }).strict();
