...
export const RoomFindFirstSelectSchema: z.ZodType<Prisma.RoomSelect, z.ZodTypeDef, Prisma.RoomSelect> = z.object({
...
export const RoomFindFirstSchema: z.ZodType<Prisma.RoomFindFirstArgs, z.ZodTypeDef, Prisma.RoomFindFirstArgs> = z.object({ select: RoomFindFirstSelectSchema.optional(), include: z.lazy(() => RoomIncludeObjectSchema.optional()), orderBy: z.union([RoomOrderByWithRelationInputObjectSchema, RoomOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomWhereInputObjectSchema.optional(), cursor: RoomWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomScalarFieldEnumSchema, RoomScalarFieldEnumSchema.array()]).optional() }).strict();

export const RoomFindFirstZodSchema = z.object({ select: RoomFindFirstSelectSchema.optional(), include: z.lazy(() => RoomIncludeObjectSchema.optional()), orderBy: z.union([RoomOrderByWithRelationInputObjectSchema, RoomOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomWhereInputObjectSchema.optional(), cursor: RoomWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomScalarFieldEnumSchema, RoomScalarFieldEnumSchema.array()]).optional() }).strict();