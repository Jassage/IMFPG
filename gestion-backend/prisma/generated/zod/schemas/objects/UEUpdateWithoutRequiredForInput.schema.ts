...
export const UEUpdateWithoutRequiredForInputObjectSchema: z.ZodType<Prisma.UEUpdateWithoutRequiredForInput, z.ZodTypeDef, Prisma.UEUpdateWithoutRequiredForInput> = z.object({
...
export const UEUpdateWithoutRequiredForInputObjectZodSchema = z.object({
  code: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  credits: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  type: z.union([UETypeSchema, z.lazy(() => EnumUETypeFieldUpdateOperationsInputObjectSchema)]).optional(),
