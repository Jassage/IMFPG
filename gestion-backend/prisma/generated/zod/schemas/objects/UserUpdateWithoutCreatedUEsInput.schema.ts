...
export const UserUpdateWithoutCreatedUEsInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutCreatedUEsInput, z.ZodTypeDef, Prisma.UserUpdateWithoutCreatedUEsInput> = z.object({
...
export const UserUpdateWithoutCreatedUEsInputObjectZodSchema = z.object({
  firstName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  lastName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  email: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  phone: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
