...
export const GuardianUpdateManyMutationInputObjectSchema: z.ZodType<Prisma.GuardianUpdateManyMutationInput, z.ZodTypeDef, Prisma.GuardianUpdateManyMutationInput> = z.object({
...
export const GuardianUpdateManyMutationInputObjectZodSchema = z.object({
  firstName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  lastName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  relationship: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  phone: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
