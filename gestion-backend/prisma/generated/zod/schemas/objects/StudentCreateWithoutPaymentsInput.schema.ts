...
export const StudentCreateWithoutPaymentsInputObjectSchema: z.ZodType<Prisma.StudentCreateWithoutPaymentsInput, z.ZodTypeDef, Prisma.StudentCreateWithoutPaymentsInput> = z.object({
...
export const StudentCreateWithoutPaymentsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  firstName: z.string(),
  lastName: z.string(),
  studentId: z.string(),
