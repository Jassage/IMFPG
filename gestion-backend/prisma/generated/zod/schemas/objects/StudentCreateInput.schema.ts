...
export const StudentCreateInputObjectSchema: z.ZodType<Prisma.StudentCreateInput, z.ZodTypeDef, Prisma.StudentCreateInput> = z.object({
...
export const StudentCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  firstName: z.string(),
  lastName: z.string(),
  studentId: z.string(),
