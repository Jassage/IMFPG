...
export const ScholarshipUpdateManyMutationInputObjectSchema: z.ZodType<Prisma.ScholarshipUpdateManyMutationInput, z.ZodTypeDef, Prisma.ScholarshipUpdateManyMutationInput> = z.object({
...
export const ScholarshipUpdateManyMutationInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
  amount: z.union([z.number(), z.lazy(() => FloatFieldUpdateOperationsInputObjectSchema)]).optional(),
  criteria: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
