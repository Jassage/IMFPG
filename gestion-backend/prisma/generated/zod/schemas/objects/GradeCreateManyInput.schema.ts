...
export const GradeCreateManyInputObjectSchema: z.ZodType<Prisma.GradeCreateManyInput, z.ZodTypeDef, Prisma.GradeCreateManyInput> = z.object({
...
export const GradeCreateManyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  studentId: z.string(),
  ueId: z.string(),
  grade: z.number(),
