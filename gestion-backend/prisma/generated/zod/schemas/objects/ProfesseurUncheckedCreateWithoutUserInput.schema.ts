...
export const ProfesseurUncheckedCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.ProfesseurUncheckedCreateWithoutUserInput, z.ZodTypeDef, Prisma.ProfesseurUncheckedCreateWithoutUserInput> = z.object({
...
export const ProfesseurUncheckedCreateWithoutUserInputObjectZodSchema = z.object({
  id: z.string().optional(),
  firstName: z.string(),
  lastName: z.string(),
  email: z.string(),
