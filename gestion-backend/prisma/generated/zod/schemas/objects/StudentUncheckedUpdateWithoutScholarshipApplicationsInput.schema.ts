...
import { AttendanceUncheckedUpdateManyWithoutStudentNestedInputObjectSchema } from './AttendanceUncheckedUpdateManyWithoutStudentNestedInput.schema';
...
export const StudentUncheckedUpdateWithoutScholarshipApplicationsInputObjectSchema: z.ZodType<Prisma.StudentUncheckedUpdateWithoutScholarshipApplicationsInput, z.ZodTypeDef, Prisma.StudentUncheckedUpdateWithoutScholarshipApplicationsInput> = z.object({
  ...
  attendances: z.lazy(() => AttendanceUncheckedUpdateManyWithoutStudentNestedInputObjectSchema).optional(),
  certificates: z.lazy(() => CertificateUncheckedUpdateManyWithoutStudentNestedInputObjectSchema).optional()
}).strict();
export const StudentUncheckedUpdateWithoutScholarshipApplicationsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  firstName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  lastName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  studentId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
