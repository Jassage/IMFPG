...
export const BookLoanMinAggregateInputObjectSchema: z.ZodType<Prisma.BookLoanMinAggregateInputType, z.ZodTypeDef, Prisma.BookLoanMinAggregateInputType> = z.object({
...
export const BookLoanMinAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  bookId: z.literal(true).optional(),
  studentId: z.literal(true).optional(),
  loanDate: z.literal(true).optional(),
