...
export const FacultyUpdateWithoutEnrollmentsInputObjectSchema: z.ZodType<Prisma.FacultyUpdateWithoutEnrollmentsInput, z.ZodTypeDef, Prisma.FacultyUpdateWithoutEnrollmentsInput> = z.object({
...
export const FacultyUpdateWithoutEnrollmentsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  code: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
  dean: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
