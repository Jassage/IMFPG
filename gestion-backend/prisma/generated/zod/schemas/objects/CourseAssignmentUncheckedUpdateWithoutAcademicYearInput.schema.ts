...
export const CourseAssignmentUncheckedUpdateWithoutAcademicYearInputObjectSchema: z.ZodType<Prisma.CourseAssignmentUncheckedUpdateWithoutAcademicYearInput, z.ZodTypeDef, Prisma.CourseAssignmentUncheckedUpdateWithoutAcademicYearInput> = z.object({
...
export const CourseAssignmentUncheckedUpdateWithoutAcademicYearInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  ueId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  facultyId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  professeurId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
