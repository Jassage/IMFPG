...
export const ProfesseurCreateWithoutAssignmentsInputObjectSchema: z.ZodType<Prisma.ProfesseurCreateWithoutAssignmentsInput, z.ZodTypeDef, Prisma.ProfesseurCreateWithoutAssignmentsInput> = z.object({
...
export const ProfesseurCreateWithoutAssignmentsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  firstName: z.string(),
  lastName: z.string(),
  email: z.string(),
