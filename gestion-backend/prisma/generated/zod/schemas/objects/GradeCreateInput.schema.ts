...
export const GradeCreateInputObjectSchema: z.ZodType<Prisma.GradeCreateInput, z.ZodTypeDef, Prisma.GradeCreateInput> = z.object({
...
export const GradeCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  grade: z.number(),
  status: GradeStatusSchema,
  session: SessionTypeSchema,
