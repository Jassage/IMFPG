...
export const CourseAssignmentCreateInputObjectSchema: z.ZodType<Prisma.CourseAssignmentCreateInput, z.ZodTypeDef, Prisma.CourseAssignmentCreateInput> = z.object({
...
export const CourseAssignmentCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  semester: SemesterSchema,
  level: z.string(),
  status: z.string().optional(),
