...
export const CertificateUpdateWithoutStudentInputObjectSchema: z.ZodType<Prisma.CertificateUpdateWithoutStudentInput, z.ZodTypeDef, Prisma.CertificateUpdateWithoutStudentInput> = z.object({
...
export const CertificateUpdateWithoutStudentInputObjectZodSchema = z.object({
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  issueDate: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  validUntil: z.union([z.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).nullish(),
