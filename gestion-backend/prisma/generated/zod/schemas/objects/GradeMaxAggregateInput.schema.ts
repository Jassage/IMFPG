...
export const GradeMaxAggregateInputObjectSchema: z.ZodType<Prisma.GradeMaxAggregateInputType, z.ZodTypeDef, Prisma.GradeMaxAggregateInputType> = z.object({
...
export const GradeMaxAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  studentId: z.literal(true).optional(),
  ueId: z.literal(true).optional(),
  grade: z.literal(true).optional(),
