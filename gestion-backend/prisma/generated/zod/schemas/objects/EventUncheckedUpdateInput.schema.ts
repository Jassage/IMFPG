...
import { EventParticipantUncheckedUpdateManyWithoutEventNestedInputObjectSchema } from './EventParticipantUncheckedUpdateManyWithoutEventNestedInput.schema'

export const EventUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.EventUncheckedUpdateInput, z.ZodTypeDef, Prisma.EventUncheckedUpdateInput> = z.object({
  ...
  participants: z.lazy(() => EventParticipantUncheckedUpdateManyWithoutEventNestedInputObjectSchema).optional()
}).strict();
export const EventUncheckedUpdateInputObjectZodSchema = z.object({
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).nullish(),
  startDate: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  endDate: z.union([z.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
