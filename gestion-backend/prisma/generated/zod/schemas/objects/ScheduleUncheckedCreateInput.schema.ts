...
export const ScheduleUncheckedCreateInputObjectSchema: z.ZodType<Prisma.ScheduleUncheckedCreateInput, z.ZodTypeDef, Prisma.ScheduleUncheckedCreateInput> = z.object({
...
export const ScheduleUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  assignmentId: z.string(),
  dayOfWeek: z.number().int(),
  startTime: z.string(),
