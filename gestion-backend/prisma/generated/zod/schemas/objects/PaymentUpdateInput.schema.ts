...
export const PaymentUpdateInputObjectSchema: z.ZodType<Prisma.PaymentUpdateInput, z.ZodTypeDef, Prisma.PaymentUpdateInput> = z.object({
...
export const PaymentUpdateInputObjectZodSchema = z.object({
  amount: z.union([z.number(), z.lazy(() => FloatFieldUpdateOperationsInputObjectSchema)]).optional(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  moyen: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  status: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
