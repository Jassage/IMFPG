...
export const FacultyUncheckedCreateWithoutEnrollmentsInputObjectSchema: z.ZodType<Prisma.FacultyUncheckedCreateWithoutEnrollmentsInput, z.ZodTypeDef, Prisma.FacultyUncheckedCreateWithoutEnrollmentsInput> = z.object({
...
export const FacultyUncheckedCreateWithoutEnrollmentsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  code: z.string(),
  description: z.string().nullish(),
