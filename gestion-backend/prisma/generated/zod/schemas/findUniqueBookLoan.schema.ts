...
export const BookLoanFindUniqueSchema = z.object({ select: BookLoanSelectObjectSchema.optional(), include: BookLoanIncludeObjectSchema.optional(), where: BookLoanWhereUniqueInputObjectSchema })