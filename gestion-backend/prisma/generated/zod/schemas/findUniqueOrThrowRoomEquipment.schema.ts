...
export const RoomEquipmentFindUniqueOrThrowSchema = z.object({ select: RoomEquipmentSelectObjectSchema.optional(), include: RoomEquipmentIncludeObjectSchema.optional(), where: RoomEquipmentWhereUniqueInputObjectSchema })