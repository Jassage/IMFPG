...
export const UEFindFirstSelectSchema: z.ZodType<Prisma.UESelect, z.ZodTypeDef, Prisma.UESelect> = z.object({
...
export const UEFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    title: z.boolean().optional(),
    credits: z.boolean().optional(),
...
export const UEFindFirstSchema: z.ZodType<Prisma.UEFindFirstArgs, z.ZodTypeDef, Prisma.UEFindFirstArgs> = z.object({ select: UEFindFirstSelectSchema.optional(), include: z.lazy(() => UEIncludeObjectSchema.optional()), orderBy: z.union([UEOrderByWithRelationInputObjectSchema, UEOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEWhereInputObjectSchema.optional(), cursor: UEWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEScalarFieldEnumSchema, UEScalarFieldEnumSchema.array()]).optional() }).strict();

export const UEFindFirstZodSchema = z.object({ select: UEFindFirstSelectSchema.optional(), include: z.lazy(() => UEIncludeObjectSchema.optional()), orderBy: z.union([UEOrderByWithRelationInputObjectSchema, UEOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEWhereInputObjectSchema.optional(), cursor: UEWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEScalarFieldEnumSchema, UEScalarFieldEnumSchema.array()]).optional() }).strict();