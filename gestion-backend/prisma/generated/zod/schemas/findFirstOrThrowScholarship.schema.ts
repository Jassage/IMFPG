...
export const ScholarshipFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ScholarshipSelect, z.ZodTypeDef, Prisma.ScholarshipSelect> = z.object({
...
export const ScholarshipFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    amount: z.boolean().optional(),
...
export const ScholarshipFindFirstOrThrowSchema: z.ZodType<Prisma.ScholarshipFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.ScholarshipFindFirstOrThrowArgs> = z.object({ select: ScholarshipFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ScholarshipIncludeObjectSchema.optional()), orderBy: z.union([ScholarshipOrderByWithRelationInputObjectSchema, ScholarshipOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScholarshipWhereInputObjectSchema.optional(), cursor: ScholarshipWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScholarshipScalarFieldEnumSchema, ScholarshipScalarFieldEnumSchema.array()]).optional() }).strict();

export const ScholarshipFindFirstOrThrowZodSchema = z.object({ select: ScholarshipFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ScholarshipIncludeObjectSchema.optional()), orderBy: z.union([ScholarshipOrderByWithRelationInputObjectSchema, ScholarshipOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScholarshipWhereInputObjectSchema.optional(), cursor: ScholarshipWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScholarshipScalarFieldEnumSchema, ScholarshipScalarFieldEnumSchema.array()]).optional() }).strict();