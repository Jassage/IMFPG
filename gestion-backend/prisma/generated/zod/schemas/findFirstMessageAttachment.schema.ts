...
export const MessageAttachmentFindFirstSelectSchema: z.ZodType<Prisma.MessageAttachmentSelect, z.ZodTypeDef, Prisma.MessageAttachmentSelect> = z.object({
...
export const MessageAttachmentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    messageId: z.boolean().optional(),
    message: z.boolean().optional(),
    url: z.boolean().optional()
...
export const MessageAttachmentFindFirstSchema: z.ZodType<Prisma.MessageAttachmentFindFirstArgs, z.ZodTypeDef, Prisma.MessageAttachmentFindFirstArgs> = z.object({ select: MessageAttachmentFindFirstSelectSchema.optional(), include: z.lazy(() => MessageAttachmentIncludeObjectSchema.optional()), orderBy: z.union([MessageAttachmentOrderByWithRelationInputObjectSchema, MessageAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: MessageAttachmentWhereInputObjectSchema.optional(), cursor: MessageAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MessageAttachmentScalarFieldEnumSchema, MessageAttachmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const MessageAttachmentFindFirstZodSchema = z.object({ select: MessageAttachmentFindFirstSelectSchema.optional(), include: z.lazy(() => MessageAttachmentIncludeObjectSchema.optional()), orderBy: z.union([MessageAttachmentOrderByWithRelationInputObjectSchema, MessageAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: MessageAttachmentWhereInputObjectSchema.optional(), cursor: MessageAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MessageAttachmentScalarFieldEnumSchema, MessageAttachmentScalarFieldEnumSchema.array()]).optional() }).strict();