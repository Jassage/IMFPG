...
export const RetakeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RetakeSelect, z.ZodTypeDef, Prisma.RetakeSelect> = z.object({
...
export const RetakeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student: z.boolean().optional(),
    studentId: z.boolean().optional(),
    ue: z.boolean().optional(),
...
export const RetakeFindFirstOrThrowSchema: z.ZodType<Prisma.RetakeFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.RetakeFindFirstOrThrowArgs> = z.object({ select: RetakeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RetakeIncludeObjectSchema.optional()), orderBy: z.union([RetakeOrderByWithRelationInputObjectSchema, RetakeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RetakeWhereInputObjectSchema.optional(), cursor: RetakeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RetakeScalarFieldEnumSchema, RetakeScalarFieldEnumSchema.array()]).optional() }).strict();

export const RetakeFindFirstOrThrowZodSchema = z.object({ select: RetakeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RetakeIncludeObjectSchema.optional()), orderBy: z.union([RetakeOrderByWithRelationInputObjectSchema, RetakeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RetakeWhereInputObjectSchema.optional(), cursor: RetakeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RetakeScalarFieldEnumSchema, RetakeScalarFieldEnumSchema.array()]).optional() }).strict();