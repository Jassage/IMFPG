...
export const FacultyLevelFindUniqueSchema = z.object({ select: FacultyLevelSelectObjectSchema.optional(), include: FacultyLevelIncludeObjectSchema.optional(), where: FacultyLevelWhereUniqueInputObjectSchema })