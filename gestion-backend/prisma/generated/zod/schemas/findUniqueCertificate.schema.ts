...
export const CertificateFindUniqueSchema = z.object({ select: CertificateSelectObjectSchema.optional(), include: CertificateIncludeObjectSchema.optional(), where: CertificateWhereUniqueInputObjectSchema })