...
export const AcademicYearFindUniqueOrThrowSchema = z.object({ select: AcademicYearSelectObjectSchema.optional(), include: AcademicYearIncludeObjectSchema.optional(), where: AcademicYearWhereUniqueInputObjectSchema })