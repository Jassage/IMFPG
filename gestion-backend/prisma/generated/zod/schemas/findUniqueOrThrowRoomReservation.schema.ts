...
export const RoomReservationFindUniqueOrThrowSchema = z.object({ select: RoomReservationSelectObjectSchema.optional(), include: RoomReservationIncludeObjectSchema.optional(), where: RoomReservationWhereUniqueInputObjectSchema })