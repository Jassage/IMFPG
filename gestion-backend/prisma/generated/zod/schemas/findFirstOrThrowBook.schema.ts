...
export const BookFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BookSelect, z.ZodTypeDef, Prisma.BookSelect> = z.object({
...
export const BookFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    author: z.boolean().optional(),
    isbn: z.boolean().optional(),
...
export const BookFindFirstOrThrowSchema: z.ZodType<Prisma.BookFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.BookFindFirstOrThrowArgs> = z.object({ select: BookFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BookIncludeObjectSchema.optional()), orderBy: z.union([BookOrderByWithRelationInputObjectSchema, BookOrderByWithRelationInputObjectSchema.array()]).optional(), where: BookWhereInputObjectSchema.optional(), cursor: BookWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BookScalarFieldEnumSchema, BookScalarFieldEnumSchema.array()]).optional() }).strict();

export const BookFindFirstOrThrowZodSchema = z.object({ select: BookFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BookIncludeObjectSchema.optional()), orderBy: z.union([BookOrderByWithRelationInputObjectSchema, BookOrderByWithRelationInputObjectSchema.array()]).optional(), where: BookWhereInputObjectSchema.optional(), cursor: BookWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BookScalarFieldEnumSchema, BookScalarFieldEnumSchema.array()]).optional() }).strict();