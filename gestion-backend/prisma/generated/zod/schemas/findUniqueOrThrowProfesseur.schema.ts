...
export const ProfesseurFindUniqueOrThrowSchema = z.object({ select: ProfesseurSelectObjectSchema.optional(), include: ProfesseurIncludeObjectSchema.optional(), where: ProfesseurWhereUniqueInputObjectSchema })