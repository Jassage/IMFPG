...
export const ScholarshipFindUniqueSchema = z.object({ select: ScholarshipSelectObjectSchema.optional(), include: ScholarshipIncludeObjectSchema.optional(), where: ScholarshipWhereUniqueInputObjectSchema })