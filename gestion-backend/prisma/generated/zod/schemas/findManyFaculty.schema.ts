...
export const FacultyFindManySelectSchema: z.ZodType<Prisma.FacultySelect, z.ZodTypeDef, Prisma.FacultySelect> = z.object({
...
export const FacultyFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const FacultyFindManySchema: z.ZodType<Prisma.FacultyFindManyArgs, z.ZodTypeDef, Prisma.FacultyFindManyArgs> = z.object({ select: FacultyFindManySelectSchema.optional(), include: z.lazy(() => FacultyIncludeObjectSchema.optional()), orderBy: z.union([FacultyOrderByWithRelationInputObjectSchema, FacultyOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyWhereInputObjectSchema.optional(), cursor: FacultyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyScalarFieldEnumSchema, FacultyScalarFieldEnumSchema.array()]).optional() }).strict();

export const FacultyFindManyZodSchema = z.object({ select: FacultyFindManySelectSchema.optional(), include: z.lazy(() => FacultyIncludeObjectSchema.optional()), orderBy: z.union([FacultyOrderByWithRelationInputObjectSchema, FacultyOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyWhereInputObjectSchema.optional(), cursor: FacultyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyScalarFieldEnumSchema, FacultyScalarFieldEnumSchema.array()]).optional() }).strict();