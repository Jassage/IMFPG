...
export const ScholarshipApplicationDeleteOneSchema = z.object({ select: ScholarshipApplicationSelectObjectSchema.optional(), include: ScholarshipApplicationIncludeObjectSchema.optional(), where: ScholarshipApplicationWhereUniqueInputObjectSchema  })