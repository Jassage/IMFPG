...
export const FacultyFindFirstSelectSchema: z.ZodType<Prisma.FacultySelect, z.ZodTypeDef, Prisma.FacultySelect> = z.object({
...
export const FacultyFindFirstSchema: z.ZodType<Prisma.FacultyFindFirstArgs, z.ZodTypeDef, Prisma.FacultyFindFirstArgs> = z.object({ select: FacultyFindFirstSelectSchema.optional(), include: z.lazy(() => FacultyIncludeObjectSchema.optional()), orderBy: z.union([FacultyOrderByWithRelationInputObjectSchema, FacultyOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyWhereInputObjectSchema.optional(), cursor: FacultyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyScalarFieldEnumSchema, FacultyScalarFieldEnumSchema.array()]).optional() }).strict();
