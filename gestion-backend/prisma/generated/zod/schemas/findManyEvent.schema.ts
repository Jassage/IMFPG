...
export const EventFindManySelectSchema: z.ZodType<Prisma.EventSelect, z.ZodTypeDef, Prisma.EventSelect> = z.object({
...
export const EventFindManySchema: z.ZodType<Prisma.EventFindManyArgs, z.ZodTypeDef, Prisma.EventFindManyArgs> = z.object({ select: EventFindManySelectSchema.optional(), include: z.lazy(() => EventIncludeObjectSchema.optional()), orderBy: z.union([EventOrderByWithRelationInputObjectSchema, EventOrderByWithRelationInputObjectSchema.array()]).optional(), where: EventWhereInputObjectSchema.optional(), cursor: EventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EventScalarFieldEnumSchema, EventScalarFieldEnumSchema.array()]).optional() }).strict();
