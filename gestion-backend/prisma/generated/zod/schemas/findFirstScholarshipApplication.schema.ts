...
export const ScholarshipApplicationFindFirstSelectSchema: z.ZodType<Prisma.ScholarshipApplicationSelect, z.ZodTypeDef, Prisma.ScholarshipApplicationSelect> = z.object({
...
export const ScholarshipApplicationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    scholarship: z.boolean().optional(),
    scholarshipId: z.boolean().optional(),
    student: z.boolean().optional(),
...
export const ScholarshipApplicationFindFirstSchema: z.ZodType<Prisma.ScholarshipApplicationFindFirstArgs, z.ZodTypeDef, Prisma.ScholarshipApplicationFindFirstArgs> = z.object({ select: ScholarshipApplicationFindFirstSelectSchema.optional(), include: z.lazy(() => ScholarshipApplicationIncludeObjectSchema.optional()), orderBy: z.union([ScholarshipApplicationOrderByWithRelationInputObjectSchema, ScholarshipApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScholarshipApplicationWhereInputObjectSchema.optional(), cursor: ScholarshipApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScholarshipApplicationScalarFieldEnumSchema, ScholarshipApplicationScalarFieldEnumSchema.array()]).optional() }).strict();

export const ScholarshipApplicationFindFirstZodSchema = z.object({ select: ScholarshipApplicationFindFirstSelectSchema.optional(), include: z.lazy(() => ScholarshipApplicationIncludeObjectSchema.optional()), orderBy: z.union([ScholarshipApplicationOrderByWithRelationInputObjectSchema, ScholarshipApplicationOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScholarshipApplicationWhereInputObjectSchema.optional(), cursor: ScholarshipApplicationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScholarshipApplicationScalarFieldEnumSchema, ScholarshipApplicationScalarFieldEnumSchema.array()]).optional() }).strict();