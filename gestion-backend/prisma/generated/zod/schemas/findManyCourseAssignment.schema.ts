...
export const CourseAssignmentFindManySelectSchema: z.ZodType<Prisma.CourseAssignmentSelect, z.ZodTypeDef, Prisma.CourseAssignmentSelect> = z.object({
...
export const CourseAssignmentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    ue: z.boolean().optional(),
    ueId: z.boolean().optional(),
    faculty: z.boolean().optional(),
...
export const CourseAssignmentFindManySchema: z.ZodType<Prisma.CourseAssignmentFindManyArgs, z.ZodTypeDef, Prisma.CourseAssignmentFindManyArgs> = z.object({ select: CourseAssignmentFindManySelectSchema.optional(), include: z.lazy(() => CourseAssignmentIncludeObjectSchema.optional()), orderBy: z.union([CourseAssignmentOrderByWithRelationInputObjectSchema, CourseAssignmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: CourseAssignmentWhereInputObjectSchema.optional(), cursor: CourseAssignmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CourseAssignmentScalarFieldEnumSchema, CourseAssignmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const CourseAssignmentFindManyZodSchema = z.object({ select: CourseAssignmentFindManySelectSchema.optional(), include: z.lazy(() => CourseAssignmentIncludeObjectSchema.optional()), orderBy: z.union([CourseAssignmentOrderByWithRelationInputObjectSchema, CourseAssignmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: CourseAssignmentWhereInputObjectSchema.optional(), cursor: CourseAssignmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CourseAssignmentScalarFieldEnumSchema, CourseAssignmentScalarFieldEnumSchema.array()]).optional() }).strict();