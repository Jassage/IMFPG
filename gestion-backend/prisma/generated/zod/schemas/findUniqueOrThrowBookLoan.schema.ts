...
export const BookLoanFindUniqueOrThrowSchema = z.object({ select: BookLoanSelectObjectSchema.optional(), include: BookLoanIncludeObjectSchema.optional(), where: BookLoanWhereUniqueInputObjectSchema })