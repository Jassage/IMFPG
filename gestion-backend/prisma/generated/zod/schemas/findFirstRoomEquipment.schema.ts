...
export const RoomEquipmentFindFirstSelectSchema: z.ZodType<Prisma.RoomEquipmentSelect, z.ZodTypeDef, Prisma.RoomEquipmentSelect> = z.object({
...
export const RoomEquipmentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    roomId: z.boolean().optional(),
    room: z.boolean().optional(),
    name: z.boolean().optional()
...
export const RoomEquipmentFindFirstSchema: z.ZodType<Prisma.RoomEquipmentFindFirstArgs, z.ZodTypeDef, Prisma.RoomEquipmentFindFirstArgs> = z.object({ select: RoomEquipmentFindFirstSelectSchema.optional(), include: z.lazy(() => RoomEquipmentIncludeObjectSchema.optional()), orderBy: z.union([RoomEquipmentOrderByWithRelationInputObjectSchema, RoomEquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomEquipmentWhereInputObjectSchema.optional(), cursor: RoomEquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomEquipmentScalarFieldEnumSchema, RoomEquipmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const RoomEquipmentFindFirstZodSchema = z.object({ select: RoomEquipmentFindFirstSelectSchema.optional(), include: z.lazy(() => RoomEquipmentIncludeObjectSchema.optional()), orderBy: z.union([RoomEquipmentOrderByWithRelationInputObjectSchema, RoomEquipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomEquipmentWhereInputObjectSchema.optional(), cursor: RoomEquipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomEquipmentScalarFieldEnumSchema, RoomEquipmentScalarFieldEnumSchema.array()]).optional() }).strict();