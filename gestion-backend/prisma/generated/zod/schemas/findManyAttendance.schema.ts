...
export const AttendanceFindManySelectSchema: z.ZodType<Prisma.AttendanceSelect, z.ZodTypeDef, Prisma.AttendanceSelect> = z.object({
...
export const AttendanceFindManySchema: z.ZodType<Prisma.AttendanceFindManyArgs, z.ZodTypeDef, Prisma.AttendanceFindManyArgs> = z.object({ select: AttendanceFindManySelectSchema.optional(), include: z.lazy(() => AttendanceIncludeObjectSchema.optional()), orderBy: z.union([AttendanceOrderByWithRelationInputObjectSchema, AttendanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AttendanceWhereInputObjectSchema.optional(), cursor: AttendanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AttendanceScalarFieldEnumSchema, AttendanceScalarFieldEnumSchema.array()]).optional() }).strict();
