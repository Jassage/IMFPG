...
export const EnrollmentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EnrollmentSelect, z.ZodTypeDef, Prisma.EnrollmentSelect> = z.object({
...
export const EnrollmentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student: z.boolean().optional(),
    studentId: z.boolean().optional(),
    faculty: z.boolean().optional(),
...
export const EnrollmentFindFirstOrThrowSchema: z.ZodType<Prisma.EnrollmentFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.EnrollmentFindFirstOrThrowArgs> = z.object({ select: EnrollmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EnrollmentIncludeObjectSchema.optional()), orderBy: z.union([EnrollmentOrderByWithRelationInputObjectSchema, EnrollmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EnrollmentWhereInputObjectSchema.optional(), cursor: EnrollmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EnrollmentScalarFieldEnumSchema, EnrollmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const EnrollmentFindFirstOrThrowZodSchema = z.object({ select: EnrollmentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EnrollmentIncludeObjectSchema.optional()), orderBy: z.union([EnrollmentOrderByWithRelationInputObjectSchema, EnrollmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EnrollmentWhereInputObjectSchema.optional(), cursor: EnrollmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EnrollmentScalarFieldEnumSchema, EnrollmentScalarFieldEnumSchema.array()]).optional() }).strict();