...
export const MessageAttachmentFindManySelectSchema: z.ZodType<Prisma.MessageAttachmentSelect, z.ZodTypeDef, Prisma.MessageAttachmentSelect> = z.object({
...
export const MessageAttachmentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    messageId: z.boolean().optional(),
    message: z.boolean().optional(),
    url: z.boolean().optional()
...
export const MessageAttachmentFindManySchema: z.ZodType<Prisma.MessageAttachmentFindManyArgs, z.ZodTypeDef, Prisma.MessageAttachmentFindManyArgs> = z.object({ select: MessageAttachmentFindManySelectSchema.optional(), include: z.lazy(() => MessageAttachmentIncludeObjectSchema.optional()), orderBy: z.union([MessageAttachmentOrderByWithRelationInputObjectSchema, MessageAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: MessageAttachmentWhereInputObjectSchema.optional(), cursor: MessageAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MessageAttachmentScalarFieldEnumSchema, MessageAttachmentScalarFieldEnumSchema.array()]).optional() }).strict();

export const MessageAttachmentFindManyZodSchema = z.object({ select: MessageAttachmentFindManySelectSchema.optional(), include: z.lazy(() => MessageAttachmentIncludeObjectSchema.optional()), orderBy: z.union([MessageAttachmentOrderByWithRelationInputObjectSchema, MessageAttachmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: MessageAttachmentWhereInputObjectSchema.optional(), cursor: MessageAttachmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MessageAttachmentScalarFieldEnumSchema, MessageAttachmentScalarFieldEnumSchema.array()]).optional() }).strict();