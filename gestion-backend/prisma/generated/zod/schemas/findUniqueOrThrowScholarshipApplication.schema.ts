...
export const ScholarshipApplicationFindUniqueOrThrowSchema = z.object({ select: ScholarshipApplicationSelectObjectSchema.optional(), include: ScholarshipApplicationIncludeObjectSchema.optional(), where: ScholarshipApplicationWhereUniqueInputObjectSchema })