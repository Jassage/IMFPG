...
export const EventCreateOneSchema = z.object({ select: EventSelectObjectSchema.optional(), include: EventIncludeObjectSchema.optional(), data: z.union([EventCreateInputObjectSchema, EventUncheckedCreateInputObjectSchema])  })