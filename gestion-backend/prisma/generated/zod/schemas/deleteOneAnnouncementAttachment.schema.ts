...
export const AnnouncementAttachmentDeleteOneSchema = z.object({ select: AnnouncementAttachmentSelectObjectSchema.optional(), include: AnnouncementAttachmentIncludeObjectSchema.optional(), where: AnnouncementAttachmentWhereUniqueInputObjectSchema  })