...
export const UEPrerequisiteFindManySelectSchema: z.ZodType<Prisma.UEPrerequisiteSelect, z.ZodTypeDef, Prisma.UEPrerequisiteSelect> = z.object({
...
export const UEPrerequisiteFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    ueId: z.boolean().optional(),
    prerequisiteId: z.boolean().optional(),
    ue: z.boolean().optional(),
...
export const UEPrerequisiteFindManySchema: z.ZodType<Prisma.UEPrerequisiteFindManyArgs, z.ZodTypeDef, Prisma.UEPrerequisiteFindManyArgs> = z.object({ select: UEPrerequisiteFindManySelectSchema.optional(), include: z.lazy(() => UEPrerequisiteIncludeObjectSchema.optional()), orderBy: z.union([UEPrerequisiteOrderByWithRelationInputObjectSchema, UEPrerequisiteOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEPrerequisiteWhereInputObjectSchema.optional(), cursor: UEPrerequisiteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEPrerequisiteScalarFieldEnumSchema, UEPrerequisiteScalarFieldEnumSchema.array()]).optional() }).strict();

export const UEPrerequisiteFindManyZodSchema = z.object({ select: UEPrerequisiteFindManySelectSchema.optional(), include: z.lazy(() => UEPrerequisiteIncludeObjectSchema.optional()), orderBy: z.union([UEPrerequisiteOrderByWithRelationInputObjectSchema, UEPrerequisiteOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEPrerequisiteWhereInputObjectSchema.optional(), cursor: UEPrerequisiteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEPrerequisiteScalarFieldEnumSchema, UEPrerequisiteScalarFieldEnumSchema.array()]).optional() }).strict();