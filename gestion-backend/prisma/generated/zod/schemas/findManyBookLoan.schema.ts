...
export const BookLoanFindManySelectSchema: z.ZodType<Prisma.BookLoanSelect, z.ZodTypeDef, Prisma.BookLoanSelect> = z.object({
...
export const BookLoanFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    book: z.boolean().optional(),
    bookId: z.boolean().optional(),
    student: z.boolean().optional(),
...
export const BookLoanFindManySchema: z.ZodType<Prisma.BookLoanFindManyArgs, z.ZodTypeDef, Prisma.BookLoanFindManyArgs> = z.object({ select: BookLoanFindManySelectSchema.optional(), include: z.lazy(() => BookLoanIncludeObjectSchema.optional()), orderBy: z.union([BookLoanOrderByWithRelationInputObjectSchema, BookLoanOrderByWithRelationInputObjectSchema.array()]).optional(), where: BookLoanWhereInputObjectSchema.optional(), cursor: BookLoanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BookLoanScalarFieldEnumSchema, BookLoanScalarFieldEnumSchema.array()]).optional() }).strict();

export const BookLoanFindManyZodSchema = z.object({ select: BookLoanFindManySelectSchema.optional(), include: z.lazy(() => BookLoanIncludeObjectSchema.optional()), orderBy: z.union([BookLoanOrderByWithRelationInputObjectSchema, BookLoanOrderByWithRelationInputObjectSchema.array()]).optional(), where: BookLoanWhereInputObjectSchema.optional(), cursor: BookLoanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BookLoanScalarFieldEnumSchema, BookLoanScalarFieldEnumSchema.array()]).optional() }).strict();