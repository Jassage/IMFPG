...
export const FacultyLevelFindFirstSelectSchema: z.ZodType<Prisma.FacultyLevelSelect, z.ZodTypeDef, Prisma.FacultyLevelSelect> = z.object({
...
export const FacultyLevelFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    facultyId: z.boolean().optional(),
    faculty: z.boolean().optional(),
    level: z.boolean().optional(),
...
export const FacultyLevelFindFirstSchema: z.ZodType<Prisma.FacultyLevelFindFirstArgs, z.ZodTypeDef, Prisma.FacultyLevelFindFirstArgs> = z.object({ select: FacultyLevelFindFirstSelectSchema.optional(), include: z.lazy(() => FacultyLevelIncludeObjectSchema.optional()), orderBy: z.union([FacultyLevelOrderByWithRelationInputObjectSchema, FacultyLevelOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyLevelWhereInputObjectSchema.optional(), cursor: FacultyLevelWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyLevelScalarFieldEnumSchema, FacultyLevelScalarFieldEnumSchema.array()]).optional() }).strict();

export const FacultyLevelFindFirstZodSchema = z.object({ select: FacultyLevelFindFirstSelectSchema.optional(), include: z.lazy(() => FacultyLevelIncludeObjectSchema.optional()), orderBy: z.union([FacultyLevelOrderByWithRelationInputObjectSchema, FacultyLevelOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyLevelWhereInputObjectSchema.optional(), cursor: FacultyLevelWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyLevelScalarFieldEnumSchema, FacultyLevelScalarFieldEnumSchema.array()]).optional() }).strict();