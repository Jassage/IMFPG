...
export const ScholarshipDeleteOneSchema = z.object({ select: ScholarshipSelectObjectSchema.optional(), include: ScholarshipIncludeObjectSchema.optional(), where: ScholarshipWhereUniqueInputObjectSchema  })