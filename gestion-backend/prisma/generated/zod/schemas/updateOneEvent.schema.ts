...
export const EventUpdateOneSchema = z.object({ select: EventSelectObjectSchema.optional(), include: EventIncludeObjectSchema.optional(), data: z.union([EventUpdateInputObjectSchema, EventUncheckedUpdateInputObjectSchema]), where: EventWhereUniqueInputObjectSchema  })