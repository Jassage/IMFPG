...
export const TranscriptFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TranscriptSelect, z.ZodTypeDef, Prisma.TranscriptSelect> = z.object({
...
export const TranscriptFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student: z.boolean().optional(),
    studentId: z.boolean().optional(),
    semester: z.boolean().optional(),
...
export const TranscriptFindFirstOrThrowSchema: z.ZodType<Prisma.TranscriptFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.TranscriptFindFirstOrThrowArgs> = z.object({ select: TranscriptFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TranscriptIncludeObjectSchema.optional()), orderBy: z.union([TranscriptOrderByWithRelationInputObjectSchema, TranscriptOrderByWithRelationInputObjectSchema.array()]).optional(), where: TranscriptWhereInputObjectSchema.optional(), cursor: TranscriptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TranscriptScalarFieldEnumSchema, TranscriptScalarFieldEnumSchema.array()]).optional() }).strict();

export const TranscriptFindFirstOrThrowZodSchema = z.object({ select: TranscriptFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TranscriptIncludeObjectSchema.optional()), orderBy: z.union([TranscriptOrderByWithRelationInputObjectSchema, TranscriptOrderByWithRelationInputObjectSchema.array()]).optional(), where: TranscriptWhereInputObjectSchema.optional(), cursor: TranscriptWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TranscriptScalarFieldEnumSchema, TranscriptScalarFieldEnumSchema.array()]).optional() }).strict();