...
export const EnrollmentFindUniqueSchema = z.object({ select: EnrollmentSelectObjectSchema.optional(), include: EnrollmentIncludeObjectSchema.optional(), where: EnrollmentWhereUniqueInputObjectSchema })