...
export const GradeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GradeSelect, z.ZodTypeDef, Prisma.GradeSelect> = z.object({
...
export const GradeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    student: z.boolean().optional(),
    studentId: z.boolean().optional(),
    ue: z.boolean().optional(),
...
export const GradeFindFirstOrThrowSchema: z.ZodType<Prisma.GradeFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.GradeFindFirstOrThrowArgs> = z.object({ select: GradeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GradeIncludeObjectSchema.optional()), orderBy: z.union([GradeOrderByWithRelationInputObjectSchema, GradeOrderByWithRelationInputObjectSchema.array()]).optional(), where: GradeWhereInputObjectSchema.optional(), cursor: GradeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GradeScalarFieldEnumSchema, GradeScalarFieldEnumSchema.array()]).optional() }).strict();

export const GradeFindFirstOrThrowZodSchema = z.object({ select: GradeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => GradeIncludeObjectSchema.optional()), orderBy: z.union([GradeOrderByWithRelationInputObjectSchema, GradeOrderByWithRelationInputObjectSchema.array()]).optional(), where: GradeWhereInputObjectSchema.optional(), cursor: GradeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GradeScalarFieldEnumSchema, GradeScalarFieldEnumSchema.array()]).optional() }).strict();