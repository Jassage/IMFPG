...
export const FacultyLevelFindFirstOrThrowSelectSchema: z.ZodType<Prisma.FacultyLevelSelect, z.ZodTypeDef, Prisma.FacultyLevelSelect> = z.object({
...
export const FacultyLevelFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    facultyId: z.boolean().optional(),
    faculty: z.boolean().optional(),
    level: z.boolean().optional(),
...
export const FacultyLevelFindFirstOrThrowSchema: z.ZodType<Prisma.FacultyLevelFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.FacultyLevelFindFirstOrThrowArgs> = z.object({ select: FacultyLevelFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FacultyLevelIncludeObjectSchema.optional()), orderBy: z.union([FacultyLevelOrderByWithRelationInputObjectSchema, FacultyLevelOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyLevelWhereInputObjectSchema.optional(), cursor: FacultyLevelWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyLevelScalarFieldEnumSchema, FacultyLevelScalarFieldEnumSchema.array()]).optional() }).strict();

export const FacultyLevelFindFirstOrThrowZodSchema = z.object({ select: FacultyLevelFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FacultyLevelIncludeObjectSchema.optional()), orderBy: z.union([FacultyLevelOrderByWithRelationInputObjectSchema, FacultyLevelOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyLevelWhereInputObjectSchema.optional(), cursor: FacultyLevelWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyLevelScalarFieldEnumSchema, FacultyLevelScalarFieldEnumSchema.array()]).optional() }).strict();