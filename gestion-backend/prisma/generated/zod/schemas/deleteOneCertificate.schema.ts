...
export const CertificateDeleteOneSchema = z.object({ select: CertificateSelectObjectSchema.optional(), include: CertificateIncludeObjectSchema.optional(), where: CertificateWhereUniqueInputObjectSchema  })