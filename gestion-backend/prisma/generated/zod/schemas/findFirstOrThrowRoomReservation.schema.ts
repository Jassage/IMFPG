...
export const RoomReservationFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RoomReservationSelect, z.ZodTypeDef, Prisma.RoomReservationSelect> = z.object({
...
export const RoomReservationFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    room: z.boolean().optional(),
    roomId: z.boolean().optional(),
    userId: z.boolean().optional(),
...
export const RoomReservationFindFirstOrThrowSchema: z.ZodType<Prisma.RoomReservationFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.RoomReservationFindFirstOrThrowArgs> = z.object({ select: RoomReservationFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoomReservationIncludeObjectSchema.optional()), orderBy: z.union([RoomReservationOrderByWithRelationInputObjectSchema, RoomReservationOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomReservationWhereInputObjectSchema.optional(), cursor: RoomReservationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomReservationScalarFieldEnumSchema, RoomReservationScalarFieldEnumSchema.array()]).optional() }).strict();

export const RoomReservationFindFirstOrThrowZodSchema = z.object({ select: RoomReservationFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoomReservationIncludeObjectSchema.optional()), orderBy: z.union([RoomReservationOrderByWithRelationInputObjectSchema, RoomReservationOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoomReservationWhereInputObjectSchema.optional(), cursor: RoomReservationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoomReservationScalarFieldEnumSchema, RoomReservationScalarFieldEnumSchema.array()]).optional() }).strict();