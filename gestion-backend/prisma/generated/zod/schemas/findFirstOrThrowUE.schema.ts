...
export const UEFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UESelect, z.ZodTypeDef, Prisma.UESelect> = z.object({
...
export const UEFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    title: z.boolean().optional(),
    credits: z.boolean().optional(),
...
export const UEFindFirstOrThrowSchema: z.ZodType<Prisma.UEFindFirstOrThrowArgs, z.ZodTypeDef, Prisma.UEFindFirstOrThrowArgs> = z.object({ select: UEFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UEIncludeObjectSchema.optional()), orderBy: z.union([UEOrderByWithRelationInputObjectSchema, UEOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEWhereInputObjectSchema.optional(), cursor: UEWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEScalarFieldEnumSchema, UEScalarFieldEnumSchema.array()]).optional() }).strict();

export const UEFindFirstOrThrowZodSchema = z.object({ select: UEFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => UEIncludeObjectSchema.optional()), orderBy: z.union([UEOrderByWithRelationInputObjectSchema, UEOrderByWithRelationInputObjectSchema.array()]).optional(), where: UEWhereInputObjectSchema.optional(), cursor: UEWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UEScalarFieldEnumSchema, UEScalarFieldEnumSchema.array()]).optional() }).strict();