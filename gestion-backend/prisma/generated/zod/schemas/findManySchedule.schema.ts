...
export const ScheduleFindManySelectSchema: z.ZodType<Prisma.ScheduleSelect, z.ZodTypeDef, Prisma.ScheduleSelect> = z.object({
...
export const ScheduleFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    assignment: z.boolean().optional(),
    assignmentId: z.boolean().optional(),
    dayOfWeek: z.boolean().optional(),
...
export const ScheduleFindManySchema: z.ZodType<Prisma.ScheduleFindManyArgs, z.ZodTypeDef, Prisma.ScheduleFindManyArgs> = z.object({ select: ScheduleFindManySelectSchema.optional(), include: z.lazy(() => ScheduleIncludeObjectSchema.optional()), orderBy: z.union([ScheduleOrderByWithRelationInputObjectSchema, ScheduleOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScheduleWhereInputObjectSchema.optional(), cursor: ScheduleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScheduleScalarFieldEnumSchema, ScheduleScalarFieldEnumSchema.array()]).optional() }).strict();

export const ScheduleFindManyZodSchema = z.object({ select: ScheduleFindManySelectSchema.optional(), include: z.lazy(() => ScheduleIncludeObjectSchema.optional()), orderBy: z.union([ScheduleOrderByWithRelationInputObjectSchema, ScheduleOrderByWithRelationInputObjectSchema.array()]).optional(), where: ScheduleWhereInputObjectSchema.optional(), cursor: ScheduleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ScheduleScalarFieldEnumSchema, ScheduleScalarFieldEnumSchema.array()]).optional() }).strict();